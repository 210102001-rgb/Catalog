            ...
            <div className="space-y-6">
                <div className="bg-red-500/10 border border-red-500/20 p-5 rounded-2xl">
                    ...
                    <p className="text-red-400/80 text-xs leading-relaxed font-medium">
                        Anda akan mengajukan pembatalan untuk pesanan <strong className="text-red-400">{order.id}</strong>.
                        Sesuai S&K, dana yang telah dibayarkan mungkin tidak dapat dikembalikan seutuhnya jika produksi telah dimulai.
                    </p>
                </div>
                ...
                <div className="pt-4 flex gap-3">
                    <button
                        onClick={onClose}
                        className="flex-1 bg-white/5 hover:bg-white/10 text-white font-bold py-4 rounded-2xl border border-white/10 transition-all text-sm"
                    >
                        Kembali
                    </button>
                    <button
                        onClick={() => {
                            if (!reason) return alert('Mohon isi alasan pembatalan.');
                            alert('Pengajuan pembatalan telah dikirim ke admin.');
                            onClose();
                        }}
