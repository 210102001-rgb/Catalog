            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4">
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-[#5a718a] uppercase tracking-widest pl-1">Durasi Sewa (Bulan)</label>
                        <input
                            type="number"
                            value={duration}
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-[#5a718a] uppercase tracking-widest pl-1">Catatan Perubahan</label>
                        <textarea
                            value={notes}
                ...
                <div className="pt-4 flex gap-3">
                    ...
                    <button
                        onClick={() => {
                            alert('Permintaan perubahan telah dikirim ke admin.');
                            onClose();
                        }}
