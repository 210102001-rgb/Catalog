...
export default function LogoutModal({ isOpen, onClose }: LogoutModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Keluar Akun">
      <div className="text-center py-6">
        ...
        <p className="text-[#92adc9] text-sm leading-relaxed mb-8">Sesi Anda akan dihentikan dan Anda perlu login kembali untuk mengakses portal pelanggan.</p>
        <div className="flex gap-4">
          <button onClick={onClose} className="flex-1 px-4 py-3 rounded-xl border border-white/10 text-white font-bold hover:bg-white/5 transition-all">
            Batal
          </button>
          <button
            onClick={async () => {
