...
export default function CustomerLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Login successful
        await showSuccessAlert("Login Berhasil!", data.message || "Login customer berhasil");
      ...
      <div className="flex min-h-screen flex-1">
        ...
        <div className="relative hidden w-0 flex-1 lg:block">
          ...
          <div className="absolute bottom-0 left-0 p-12 text-white">
            ...
            <p className="max-w-lg text-lg text-slate-200">Temukan lokasi strategis untuk bisnis Anda. Jelajahi ribuan titik reklame, bandingkan harga, dan sewa dengan mudah untuk jangkauan luas.</p>
          </div>
        </div>
        ...
        <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-background-dark">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            ...
            <div className="flex flex-col gap-2 mb-10">
              <h1 className="text-white text-4xl font-black leading-tight tracking-[-0.033em]">Login Customer</h1>
              <p className="text-[#92adc9] text-base font-normal leading-normal">{activeTab === "admin" ? "Masuk untuk mengelola produk, pesanan, dan toko." : "Masuk untuk mulai mencari dan menyewa reklame."}</p>
            </div>
