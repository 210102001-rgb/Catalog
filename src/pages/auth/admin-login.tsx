                ...
                <div className="relative hidden w-0 flex-1 lg:block">
                    ...
                    <div className="absolute bottom-0 left-0 p-12 text-white">
                        ...
                        <p className="max-w-lg text-lg text-slate-200">
                            Kelola bisnis reklame Anda dengan efisien.
                            Pantau inventaris, atur pesanan masuk, dan optimalkan pendapatan sewa dalam satu dashboard.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="flex flex-col gap-2 mb-10">
                            ...
                            <p className="text-slate-500 dark:text-[#92adc9] text-base font-normal leading-normal">
                                {activeTab === 'admin'
                                    ...
                                    : 'Masuk untuk mencari dan menyewa reklame.'}
                            </p>
                        </div>
